            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30">
                        <div class="team-thumb">
                            <div class="brd">
                                <img src="{{ url('/') }}/assets/img/direktur/vector.png" class="img"
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30">
                        ...
                        <div class="team-info">
                            ...
                            <span>Dewan Penasehat</span>
                            <div class="team-social mt-15">
                                <p>Principal of Sampoerna Academy Sentul </p>
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30">
                        ...
                        <div class="team-info">
                            ...
                            <span>Dewan Penasehat</span>
                            <div class="team-social mt-15">
                                <p>Direktur Pemasaran Pariwisata Kemenparekraf</p>
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30">
                        <div class="team-thumb">
                            <div class="brd">
                                <img src="{{ url('/') }}/assets/img/direktur/2.png" class="img"
                                    alt="Gambar tentang kami">
                            </div>
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30 ">
                        <div class="team-thumb">
                            <div class="brd">
                                <img src="{{ url('/') }}/assets/img/direktur/1.png" class="img"
                                    alt="Gambar tentang kami">
                            </div>
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30 ">
                        <div class="team-thumb">
                            <div class="brd">
                                <img src="{{ url('/') }}/assets/img/direktur/5.png" class="img"
                                    alt="Gambar tentang kami">
                            </div>
                        </div>
                        <div class="team-info">
                            <h4>Ghazi Prasetyo</h4>
                            <span>Co-Founder</span>
                            <div class="team-social mt-15">
                                <p><strong>Minat Bakat:</strong> <br>Olahraga,Sejarah,Bahasa Indonesia</p>
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30 ">
                        <div class="team-thumb">
                            <div class="brd">
                                <img src="{{ url('/') }}/assets/img/direktur/3.png" class="img"
                                    alt="Gambar tentang kami">
                            </div>
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30 ">
                        <div class="team-thumb">
                            <div class="brd">
                                <img src="{{ url('/') }}/assets/img/direktur/4.png" class="img"
                                    alt="Gambar tentang kami">
                            </div>
                        </div>
                        <div class="team-info">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30">
                        ...
                        <div class="team-info">
                            <h4>Gabriella Abigail                             </h4>
                            <span>Cief Administration</span>
                            <div class="team-social mt-15">
                                <p><strong>Minat Bakat:</strong> <br>Matematika,Bahasa Inggris,Ilmu Pengetahuan Alam</p>
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-team text-center mb-30">
                        ...
                        <div class="team-info">
                            <h4>Latasha Wijaya                            </h4>
                            <span>Chief Fund Rising</span>
                            <div class="team-social mt-15">
                                <p><strong>Minat Bakat:</strong> <br>Matematika,Bahasa Inggris,Ilmu Pengetahuan Alam</p>
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
